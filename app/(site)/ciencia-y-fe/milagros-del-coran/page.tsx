...
export const metadata: Metadata = {
  title: "Milagros del Corán | Límite ILM",
  description:
    "Artículos de Milagros del Corán en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("ciencia-y-fe/milagros-del-coran"),
