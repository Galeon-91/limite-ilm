...
export const metadata: Metadata = {
  title: "Tierra y Materia | Límite ILM",
  description:
    "Artículos de Tierra y Materia en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("tierra-y-materia"),
