...
export const metadata: Metadata = {
  title: "Geología | Límite ILM",
  description:
    "Artículos de Geología en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("tierra-y-materia/geologia"),
