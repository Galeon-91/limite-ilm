...
export const metadata: Metadata = {
  title: "Meteorología | Límite ILM",
  description:
    "Artículos de Meteorología en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("tierra-y-materia/meteorologia"),
