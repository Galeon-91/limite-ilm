...
export const metadata: Metadata = {
  title: "Cosmología | Límite ILM",
  description:
    "Artículos de Cosmología en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("ciencias-fisicas/cosmologia"),
