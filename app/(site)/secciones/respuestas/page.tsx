...
export const metadata: Metadata = {
  title: "Respuestas | Límite ILM",
  description:
    "Artículos de Respuestas en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("secciones/respuestas"),
