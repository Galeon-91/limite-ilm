...
export const metadata: Metadata = {
  title: "Zoología | Límite ILM",
  description:
    "Artículos de Zoología en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("ciencias-naturales/zoologia"),
