...
export const metadata: Metadata = {
  title: "Biología | Límite ILM",
  description:
    "Artículos de Biología en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("ciencias-naturales/biologia"),
