...
export const metadata: Metadata = {
  title: "Ciencias Naturales | Límite ILM",
  description:
    "Artículos de Ciencias Naturales en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("ciencias-naturales"),
