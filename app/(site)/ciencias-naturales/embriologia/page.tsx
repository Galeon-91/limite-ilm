...
export const metadata: Metadata = {
  title: "Embriología | Límite ILM",
  description:
    "Artículos de Embriología en Límite ILM: divulgación científica rigurosa y accesible.",
};

export default async function Page() {
  const [articles, popular, recent] = await Promise.all([
    getArticlesByCategory("ciencias-naturales/embriologia"),
